...
public class Groups extends javax.swing.JDialog {
    ...
    public Groups(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonADDActionPerformed
        NewGroup np = null;
        try {
            np = new NewGroup((Frame) this.getParent(), true, connection);
    ...
    private void jButtonALTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            NewGroup np = null;
            try {
                np = new NewGroup((Frame) this.getParent(), true,
