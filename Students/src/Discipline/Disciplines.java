...
public class Disciplines extends javax.swing.JDialog {

    Connection connection;
    DisciplineModel model;
    SizeSetter columnWidth;
    
    public Disciplines(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        connection = c;
        model = new DisciplineModel(connection);
    ...
    private void jButtonDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDELETEActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Disciplines.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonALTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            NewDiscipline np = new NewDiscipline((Frame) this.getParent(), true,
    ...
    private void jButtonADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonADDActionPerformed
        NewDiscipline np = new NewDiscipline((Frame) this.getParent(), true, connection);
        np.setVisible(true);
        try {
            model.updateData();
        } catch (SQLException ex) {
