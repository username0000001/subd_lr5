...
public class Facultets extends javax.swing.JDialog {

    Connection connection;
    FacultetModel model;
    SizeSetter columnWidth;
    
    public Facultets(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        connection = c;

        model = new FacultetModel(connection);
    ...
    private void jButtonDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDELETEActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Facultets.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonALTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            NewFacultet np = new NewFacultet((Frame) this.getParent(), true,
    ...
    private void jButtonADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonADDActionPerformed
        NewFacultet np = new NewFacultet((Frame) this.getParent(), true, connection);
        np.setVisible(true);
        try {
            model.updateData();
        } catch (SQLException ex) {
